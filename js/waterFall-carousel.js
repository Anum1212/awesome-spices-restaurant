    ...
    $.fn.waterwheelCarousel = function (startingOptions) {
        ...
        function itemAnimationComplete($item, newPosition) {
            ...
            if (data.itemsAnimating === 0) {
                ...
                if (data.carouselRotationsLeft > 0) {
                    ...
                    data.currentCenterItem.find("img").css({"width":"170px", "height":"170px"});
                    data.currentCenterItem.find(".carousel_desc").show();
                    data.currentCenterItem.find(".caption").append('<span class="activeDot"></span>');
                    if ($('.activeDot').length >= 2) {
                        $(".activeDot").last().remove();
                    }
        ...
        function rotateCarousel(rotations) {
            ...
            if (data.currentlyMoving === false) {
                ...
                data.currentCenterItem.find(".activeDot").remove();
                    data.currentCenterItem.find("img").css({"width":"150px", "height":"150px"});
                    data.currentCenterItem.find(".carousel_desc").hide();
